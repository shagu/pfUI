...
pfLocaleSpellEvents["ruRU"] = { -- checkcheck
  ['SPELL_GAINS'] = "(.+) получает эффект \"(.+)\".", --"%s получает эффект \"%s\"."
  ['SPELL_CAST'] = "(.+) начинает использовать \"(.+)\".", --"%s начинает использовать \"%s\"."
  ['SPELL_PERFORM'] = "(.+) начинает выполнять действие \"(.+)\".", --"%s начинает выполнять действие \"%s\"."
  ['SPELL_AFFLICTED'] = "(.+) находится под воздействием эффекта \"(.+)\".", --"%s находится под воздействием эффекта \"%s\"."
  ['SPELL_HIT'] = "Ваше заклинание \"(.+)\" наносит (.+) %d+\ед. урона.", --"Ваше заклинание \"%s\" наносит %s %d ед. урона."

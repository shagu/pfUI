pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(U["nameplates"], T["Enable Name Reaction Colors"], C.nameplates, "namereactionc", "checkbox")
      CreateConfig(U["nameplates"], T["Enable Combat Icon"], C.nameplates, "combaticon", "checkbox")
      ...
      CreateConfig(U["nameplates"], T["Enable Low Health Colors"], C.nameplates, "lowhealthc", "checkbox")
    end)

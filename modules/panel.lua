pfUI:RegisterModule("panel", function ()
  ...
  pfUI.panel.clock:SetScript("OnUpdate",function(s,e)
    ...
    if GetTime() >= pfUI.panel.clock.tick + 1 then
      ...
      local tooltip = function ()
        ...
        GameTooltip:AddDoubleLine("Network Down", "|cffffffff" .. pfUI:round(nin,1) .. "KB/s")
        GameTooltip:AddDoubleLine("Network Up", "|cffffffff" .. pfUI:round(nout,1) .. "KB/s")
        ...
        GameTooltip:AddDoubleLine("UI-Scale", "|cffffffff" .. pfUI:round(UIParent:GetEffectiveScale(),2))
        GameTooltip:Show()
      end
  ...
  function pfUI.panel:UpdateZone ()
    local tooltip = function ()
      ...
      GameTooltip:AddLine("|cffaaaaaa" .. pfUI:round(posX*100,1) .. " / " .. pfUI:round(posY*100,1))
      GameTooltip:Show()
    end

pfUI:RegisterModule("target", function ()
  ...
  pfUI.uf.target.hpText:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)
  ...
  pfUI.uf.target.powerText:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)
  ...
  for i=1, 16 do
    ...
    pfUI.uf.target.buff.buffs[i].stacks:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)
  ...
  for i=1, 16 do
    ...
    pfUI.uf.target.debuff.debuffs[i].stacks:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)

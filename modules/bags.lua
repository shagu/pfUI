pfUI:RegisterModule("bags", function ()
  ...
  function pfUI.bag:UpdateSlot(bag, slot)
    ...
    count:SetFont(pfUI.font_square, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
    count:SetAllPoints()
  ...
  function pfUI.bag:CreateBagSlots(frame)
    ...
    if frame == pfUI.bag.left then
      if GetNumBankSlots() < 6 then
        ...
        frame.bagslots.buy:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
  ...
  function pfUI.bag:CreateAdditions(frame)
    ...
    if frame == pfUI.bag.right then
      ...
      if not frame.bags then
        ...
        frame.bags:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
      ...
      if not frame.keys then
        ...
        frame.keys:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
      ...
      if not frame.search then
        ...
        frame.search.edit:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)

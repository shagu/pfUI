pfUI:RegisterModule("chat", function ()
  ...
  pfUI.chat.left.panelTop.proxyName.caption:SetFont(pfUI.font_default, pfUI_config.global.font_size + 2, STANDARD_TEXT_FONT_FLAGS)
  ...
  pfUI.chat.left.panelTop.proxyName.okay.text:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
  ...
  pfUI.chat.left.panelTop.proxyName.abort.text:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
  ...
  function pfUI.chat:RefreshChat()
    ...
    for i=1, NUM_CHAT_WINDOWS do
      ...
      getglobal("ChatFrame" .. i .. "TabText"):SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
  ...
  for i,v in ipairs({ChatFrameEditBox:GetRegions()}) do
    ...
    if v.SetFont then
      v:SetFont(pfUI.font_default, pfUI_config.global.font_size + 1, STANDARD_TEXT_FONT_FLAGS)
    end
  end

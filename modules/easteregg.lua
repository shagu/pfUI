pfUI:RegisterModule("easteregg", function ()
  if date("%m%d") == "1224" or date("%m%d") == "1225" then
    ...
    _G.MARKED_AFK           = "|cff33ffccpf|cffffffffUI|r whishes you a merry christmas, |cff33ffcc" .. title .. "|r."
    _G.MARKED_AFK_MESSAGE   = "|cff33ffccpf|cffffffffUI|r whishes you a merry christmas, |cff33ffcc" .. title .. "|r: %s"

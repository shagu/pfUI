pfUI:RegisterModule("roll", function ()
  ...
  function pfUI.roll:CreateLootRoll(id)
    ...
    f.boe.text:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
    ...
    f.name.text:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
    ...
    local r, g, b, a = pfUI.api.strsplit(",", pfUI_config.appearance.border.color)

pfUI:RegisterModule("actionbar", function ()
  ...
  for i = 1, NUM_SHAPESHIFT_SLOTS do
    ...
    getglobal("ShapeshiftButton"..i..'HotKey'):SetFont(pfUI.font_square, pfUI_config.global.font_size -2, STANDARD_TEXT_FONT_FLAGS)
  ...
  for i = 1, NUM_ACTIONBAR_BUTTONS do
    for _, button in pairs(actionbars) do
      ...
      getglobal(button..i..'HotKey'):SetFont(pfUI.font_square, pfUI_config.global.font_size -2, STANDARD_TEXT_FONT_FLAGS)
      ...
      getglobal(button..i..'Name'):SetFont(pfUI.font_square, pfUI_config.global.font_size -2, STANDARD_TEXT_FONT_FLAGS)

pfUI:RegisterModule("addons", function ()
  ...
  pfUI.addons:SetBackdrop(pfUI.backdrop)
  pfUI.addons:SetBackdropColor(0,0,0,.8)
  ...
  pfUI.addons.caption:SetFont("Interface\\AddOns\\pfUI\\fonts\\" .. pfUI_config.global.font_default .. ".ttf", pfUI_config.global.font_size + 4, "OUTLINE")
  ...
  pfUI.addons.close:SetPoint("TOPRIGHT", -pfUI_config.bars.border*2,-pfUI_config.bars.border*2 )
  pfUI.addons.close:SetBackdrop(pfUI.backdrop)
  ...
  pfUI.addons.close:SetScript("OnEnter", function ()
    pfUI.addons.close:SetBackdrop(pfUI.backdrop_col)
    pfUI.addons.close:SetBackdropBorderColor(1,.25,.25,1)
  end)

  pfUI.addons.close:SetScript("OnLeave", function ()
    pfUI.addons.close:SetBackdrop(pfUI.backdrop)
    pfUI.addons.close:SetBackdropBorderColor(1,1,1,1)
  end)
  ...
  function pfUI.addons.scroll:UpdateScrollState()
    local current = ceil(pfUI.addons.scroll:GetVerticalScroll() / UIParent:GetEffectiveScale())
  ...
  pfUI.addons.deco:SetBackdrop(pfUI.backdrop)
  pfUI.addons.deco:SetBackdropColor(0,0,0,.50)

  pfUI.addons.deco.up = CreateFrame("Frame", nil, pfUI.addons.deco)
  pfUI.addons.deco.up:SetPoint("TOPRIGHT", 0,0)
  pfUI.addons.deco.up:SetHeight(16)
  pfUI.addons.deco.up:SetWidth(pfUI.addons.deco:GetWidth())
  ...
  pfUI.addons.deco.down:SetPoint("BOTTOMRIGHT", 0,0)

...
function pfUI:UpdateFonts()
  ...
  GameTooltipText:SetFont(C.global.font_tooltip, C.global.font_tooltip_size)
  GameTooltipTextSmall:SetFont(C.global.font_tooltip, C.global.font_tooltip_size)
  GameTooltipHeaderText:SetFont(C.global.font_tooltip, C.global.font_tooltip_size + 1)

pfUI:RegisterModule("xpbar", function ()
  ...
  pfUI.xp:SetScript("OnEnter", function()
      ...
      GameTooltip:AddDoubleLine("|cff555555经验值")
      GameTooltip:AddDoubleLine("经验", "|cffffffff" .. xp .. " / " .. xpmax .. " (" .. xp_perc .. "%)")
      GameTooltip:AddDoubleLine("升级所需", "|cffffffff" .. remaining .. " (" .. remaining_perc .. "%)")
      if IsResting() then
        GameTooltip:AddDoubleLine("状态", "|cffffffff精力充沛")
      end
      if GetXPExhaustion() then
        GameTooltip:AddDoubleLine("状态良好", "|cff5555ff+" .. exh .. " (" .. exh_perc .. "%)")
      end
      GameTooltip:Show()
    end)

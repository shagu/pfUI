pfUI:RegisterModule("player", function ()
  ...
  pfUI.uf.player.hpText:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)
  ...
  pfUI.uf.player.powerText:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)
  ...
  for i=1, 16 do
    ...
    pfUI.uf.player.buff.buffs[i].stacks:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)
    ...
    pfUI.uf.player.buff.buffs[i].cd:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)
  ...
  for i=1, 16 do
    ...
    pfUI.uf.player.debuff.debuffs[i].stacks:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)
    ...
    pfUI.uf.player.debuff.debuffs[i].cd:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)

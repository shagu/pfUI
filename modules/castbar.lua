pfUI:RegisterModule("castbar", function ()
  ...
  pfUI.castbar.player.bar.left:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
  ...
  pfUI.castbar.player.bar.right:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
  ...
  pfUI.castbar.target.bar.left:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
  ...
  pfUI.castbar.target.bar.right:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)

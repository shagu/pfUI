pfUI:RegisterModule("minimap", function ()
  ...
  pfUI.minimapCoordinates.text:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
  ...
  pfUI.minimapZone.text:SetFont(pfUI.font_default, pfUI_config.global.font_size + 2, STANDARD_TEXT_FONT_FLAGS)

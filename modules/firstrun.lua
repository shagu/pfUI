pfUI:RegisterModule("firstrun", "vanilla:tbc:wotlk", function ()
  ...
  pfUI.firstrun:AddStep("profile", function()
    ...
    SetButtonFontColor(f.Modern,1,1,1,1)
    SkinButton(f.Modern)
    ...
    SetButtonFontColor(f.Legacy,1,1,1,1)
    SkinButton(f.Legacy)
    ...
    SetButtonFontColor(f.Slim,1,1,1,1)
    SkinButton(f.Slim)
    ...
    SetButtonFontColor(f.Adapta,1,1,1,1)
    SkinButton(f.Adapta)

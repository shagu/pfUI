  ...
  local function pfSetupClean_Up()
    ...
    pfUI.thirdparty.cleanup:SetScript("OnEvent", function()
      ...
      if not pfUI.bag.right.sort then
        ...
        pfUI.bag.right.sort:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)
      ...
      if not pfUI.bag.left.sort then
        ...
        pfUI.bag.left.sort:SetFont(pfUI.font_default, pfUI_config.global.font_size, STANDARD_TEXT_FONT_FLAGS)

pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "纵向位置", pfUI_config.unitframes.player, "portrait", "dropdown", { "bar", "left", "right", "off" })
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "玩家能量值与头像间隔调整", pfUI_config.unitframes.player, "pspace")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "纵向位置", pfUI_config.unitframes.target, "portrait", "dropdown", { "bar", "left", "right", "off" })
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "目标能量值与头像间隔调整", pfUI_config.unitframes.target, "pspace")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "纵向位置", pfUI_config.unitframes.group, "portrait", "dropdown", { "bar", "left", "right", "off" })
  pfUI.gui:CreateConfig(pfUI.gui.uf, "小队能量值间隔调整", pfUI_config.unitframes.group, "pspace")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "团队能量值间隔调整", pfUI_config.unitframes.raid, "pspace")

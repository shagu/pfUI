pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.global, "Unit Frame Font", C.global, "font_unit", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.global, "Unit Frame Size", C.global, "font_unit_size")

pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.global, "Limit UIErrors To A Single Line", pfUI_config.global, "errors_limit", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.global, "Hide UIErrors", pfUI_config.global, "errors_hide", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Portrait Animation Speed", pfUI_config.unitframes, "animation_speed")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "UI Layout", pfUI_config.unitframes, "layout", "dropdown", { "default", "tukui" })
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Hide Group Frames When In Raid", pfUI_config.unitframes.group, "hide_in_raid", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.bar, "Show Action Bar Backgrounds", pfUI_config.bars, "background", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.bar, "BarActionMain", pfUI_config.bars.actionmain, "formfactor", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "BarBottomLeft", pfUI_config.bars.bottomleft, "formfactor", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "BarBottomRight", pfUI_config.bars.bottomright, "formfactor", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "BarRight", pfUI_config.bars.right, "formfactor", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "BarTwoRight", pfUI_config.bars.tworight, "formfactor", "dropdown", values)
  local values = pfUI.api:BarLayoutOptions(NUM_SHAPESHIFT_SLOTS)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "BarShapeShift", pfUI_config.bars.shapeshift, "formfactor", "dropdown", values)
  local values = pfUI.api:BarLayoutOptions(NUM_PET_ACTION_SLOTS)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "BarPet", pfUI_config.bars.pet, "formfactor", "dropdown", values)
  ...
  pfUI.gui:CreateConfig(pfUI.gui.panel, "Show Micro Bar", pfUI_config.panel.micro, "enable", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.chat, "Custom Incoming Whispers Layout:", pfUI_config.chat.global, "whispermod", "checkbox")

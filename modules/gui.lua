pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Settings"], T["General"], function()
      ...
      CreateConfig(nil, T["Tooltip Text Font"], C.global, "font_tooltip", "dropdown", pfUI.gui.dropdowns.fonts)
      CreateConfig(nil, T["Tooltip Text Font Size"], C.global, "font_tooltip_size")

pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui.dropdowns.uf_buff_position = {
    ...
    pfUI.gui.dropdowns.uf_healthbar_dir = {
    "Vertical:" .. T["Vertical"],
  ...
  pfUI.gui.tabs.uf.tabs.player:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Horizontal/Vertical Health Bar"], C.unitframes.player, "healthbar_dir", "dropdown", pfUI.gui.dropdowns.uf_healthbar_dir)
  ...
  pfUI.gui.tabs.uf.tabs.target:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Horizontal/Vertical Health Bar"], C.unitframes.target, "healthbar_dir", "dropdown", pfUI.gui.dropdowns.uf_healthbar_dir)
  ...
  pfUI.gui.tabs.uf.tabs.targettarget:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Horizontal/Vertical Health Bar"], C.unitframes.ttarget, "healthbar_dir", "dropdown", pfUI.gui.dropdowns.uf_healthbar_dir)
  ...
  pfUI.gui.tabs.uf.tabs.pet:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Horizontal/Vertical Health Bar"], C.unitframes.pet, "healthbar_dir", "dropdown", pfUI.gui.dropdowns.uf_healthbar_dir)
  ...
  pfUI.gui.tabs.uf.tabs.focus:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Horizontal/Vertical Health Bar"], C.unitframes.focus, "healthbar_dir", "dropdown", pfUI.gui.dropdowns.uf_healthbar_dir)
  ...
  pfUI.gui.tabs.gf.tabs.raid:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Horizontal/Vertical Health Bar"], C.unitframes.raid, "healthbar_dir", "dropdown", pfUI.gui.dropdowns.uf_healthbar_dir)
  ...
  pfUI.gui.tabs.gf.tabs.group:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Horizontal/Vertical Health Bar"], C.unitframes.group, "healthbar_dir", "dropdown", pfUI.gui.dropdowns.uf_healthbar_dir)
  ...
  pfUI.gui.tabs.gf.tabs.grouptarget:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Horizontal/Vertical Health Bar"], C.unitframes.grouptarget, "healthbar_dir", "dropdown", pfUI.gui.dropdowns.uf_healthbar_dir)
  ...
  pfUI.gui.tabs.gf.tabs.grouppet:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Horizontal/Vertical Health Bar"], C.unitframes.grouppet, "healthbar_dir", "dropdown", pfUI.gui.dropdowns.uf_healthbar_dir)

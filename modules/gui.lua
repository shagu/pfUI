pfUI:RegisterModule("gui", function ()
  ...
  do -- GUI Frame
    ...
    pfUI.gui.unlock:SetText("Unlock")
    ...
    pfUI.gui.hoverbind:SetText("Hoverbind")
  ...
  do -- Generate Config UI
    CreateGUIEntry(T["About"], nil, function()
      ...
      this.screenc:SetText("Resolution" .. ":")
      ...
      this.clientc:SetText("Gameclient" .. ":")
    ...
    for label in pairs(unitframeSettings) do
      for id, data in pairs(unitframeSettings[label]) do
        ...
        CreateGUIEntry(label == "uf" and "Unit Frames" or "Group Frames", t, function()
          ...
          CreateConfig(U[c], T["Enable Health Color"], C.unitframes[c], "healthcolor", "checkbox")
          CreateConfig(U[c], T["Enable Power Color"], C.unitframes[c], "powercolor", "checkbox")
          CreateConfig(U[c], T["Enable Level Color"], C.unitframes[c], "levelcolor", "checkbox")
          CreateConfig(U[c], T["Enable Class Color"], C.unitframes[c], "classcolor", "checkbox")
    ...
    CreateGUIEntry(T["Actionbar"], T["General"], function()
      ...
      CreateConfig(nil, "Auto Paging", nil, nil, "header")
    ...
    CreateGUIEntry(T["Castbar"], nil, function()
      ...
      CreateConfig(nil, T["Disable pfUI Player Castbar"], C.castbar.player, "hide_pfui", "checkbox")
      CreateConfig(nil, T["Disable pfUI Target Castbar"], C.castbar.target, "hide_pfui", "checkbox")
    end)

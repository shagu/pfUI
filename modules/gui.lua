pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui.tabs.settings.tabs.general:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Enable Native UI-Scale"], C.global, "pixelperfect", "checkbox")
      CreateConfig(this, T["Enable Maximum Graphic Details"], C.global, "hdgraphic", "checkbox")
  ...
  pfUI.gui.tabs.uf.tabs.player:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Hit Indicator"], nil, nil, "header")
      CreateConfig(this, T["Enable Hit Indicator"], C.unitframes.player, "hitindicator", "checkbox")
      CreateConfig(this, T["Hit Indicator Text Font"], C.unitframes.player, "hitindicatorfont", "dropdown", pfUI.gui.dropdowns.fonts)
      CreateConfig(this, T["Hit Indicator Text Size"], C.unitframes.player, "hitindicatorsize")
      this.setup = true
    end
  end)
  ...
  pfUI.gui.tabs.uf.tabs.target:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Hit Indicator"], nil, nil, "header")
      CreateConfig(this, T["Enable Hit Indicator"], C.unitframes.target, "hitindicator", "checkbox")
      CreateConfig(this, T["Hit Indicator Text Font"], C.unitframes.target, "hitindicatorfont", "dropdown", pfUI.gui.dropdowns.fonts)
      CreateConfig(this, T["Hit Indicator Text Size"], C.unitframes.target, "hitindicatorsize")
      this.setup = true
    end
  end)
  ...
  pfUI.gui.tabs.uf.tabs.pet:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Hit Indicator"], nil, nil, "header")
      CreateConfig(this, T["Enable Hit Indicator"], C.unitframes.pet, "hitindicator", "checkbox")
      CreateConfig(this, T["Hit Indicator Text Font"], C.unitframes.pet, "hitindicatorfont", "dropdown", pfUI.gui.dropdowns.fonts)
      CreateConfig(this, T["Hit Indicator Text Size"], C.unitframes.pet, "hitindicatorsize")
      this.setup = true
    end
  end)
  ...
  pfUI.gui.tabs.gf.tabs.raid:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Hit Indicator"], nil, nil, "header")
      CreateConfig(this, T["Enable Hit Indicator"], C.unitframes.raid, "hitindicator", "checkbox")
      CreateConfig(this, T["Hit Indicator Text Font"], C.unitframes.raid, "hitindicatorfont", "dropdown", pfUI.gui.dropdowns.fonts)
      CreateConfig(this, T["Hit Indicator Text Size"], C.unitframes.raid, "hitindicatorsize")
      this.setup = true
    end
  end)
  ...
  pfUI.gui.tabs.gf.tabs.group:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Hit Indicator"], nil, nil, "header")
      CreateConfig(this, T["Enable Hit Indicator"], C.unitframes.group, "hitindicator", "checkbox")
      CreateConfig(this, T["Hit Indicator Text Font"], C.unitframes.group, "hitindicatorfont", "dropdown", pfUI.gui.dropdowns.fonts)
      CreateConfig(this, T["Hit Indicator Text Size"], C.unitframes.group, "hitindicatorsize")
      this.setup = true
    end
  end)
  ...
  pfUI.gui.tabs.actionbar.tabs.general:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Show Equipped Items"], C.bars, "showequipped", "checkbox")
  ...
  pfUI.gui.tabs.castbar.tabs.general:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Show Player Spell Icon"], C.castbar.player, "show_icon", "checkbox")
      CreateConfig(this, T["Show Target Spell Icon"], C.castbar.target, "show_icon", "checkbox")
      this.setup = true
    end
  end)
  ...
  pfUI.gui.tabs.chat.tabs.general:SetScript("OnShow", function()
    if not this.setup then
      ...
      CreateConfig(this, T["Enable Text Shadow"], C.chat.text, "outline", "checkbox")

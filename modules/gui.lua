pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.global, "Standard Text Font", C.global, "font_default", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.global, "Standard Text Font Size", C.global, "font_size")
  pfUI.gui:CreateConfig(pfUI.gui.global, "Unit Frame Text Font", C.global, "font_unit", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.global, "Unit Frame Text Size", C.global, "font_unit_size")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.appearance, "Cooldown Color (Less than 3 Sec)", C.appearance.cd, "lowcolor", "color")
  pfUI.gui:CreateConfig(pfUI.gui.appearance, "Cooldown Color (Seconds)", C.appearance.cd, "normalcolor", "color")
  pfUI.gui:CreateConfig(pfUI.gui.appearance, "Cooldown Color (Minutes)", C.appearance.cd, "minutecolor", "color")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.chat, "Hide Channel Names", C.chat.text, "channelnumonly", "checkbox")

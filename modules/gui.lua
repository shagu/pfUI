pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.bar, "Main Actionbar: Cols x Rows", pfUI_config.bars.actionmain, "formfactor", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "BottomLeft Actionbar: Cols x Rows", pfUI_config.bars.bottomleft, "formfactor", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "BottomRight Actionbar: Cols x Rows", pfUI_config.bars.bottomright, "formfactor", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "Right Actionbar: Cols x Rows", pfUI_config.bars.right, "formfactor", "dropdown", values)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "Right 2nd Actionbar: Cols x Rows", pfUI_config.bars.tworight, "formfactor", "dropdown", values)
  local values = pfUI.api:BarLayoutOptions(NUM_SHAPESHIFT_SLOTS)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "Shapeshift Bar: Cols x Rows", pfUI_config.bars.shapeshift, "formfactor", "dropdown", values)
  local values = pfUI.api:BarLayoutOptions(NUM_PET_ACTION_SLOTS)
  pfUI.gui:CreateConfig(pfUI.gui.bar, "Pet Bar: Cols x Rows", pfUI_config.bars.pet, "formfactor", "dropdown", values)

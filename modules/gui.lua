pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "生命值用灰色显示", pfUI_config.unitframes, "dark", "checkbox")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "头像动画速度", pfUI_config.unitframes, "animation_speed")
  pfUI.gui:CreateConfig(pfUI.gui.uf, "显示头像动画", pfUI_config.unitframes, "portrait", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "其他", nil, nil, "header")

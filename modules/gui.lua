pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "头像位置", pfUI_config.unitframes.player, "portrait", "dropdown", { "bar", "left", "right", "off" })
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "头像位置", pfUI_config.unitframes.target, "portrait", "dropdown", { "bar", "left", "right", "off" })
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "头像位置", pfUI_config.unitframes.group, "portrait", "dropdown", { "bar", "left", "right", "off" })

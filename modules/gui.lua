pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Minimap"], T["Minimap"], function()
      ...
      CreateConfig(nil, T["Zone Text On Minimap"], C.appearance.minimap, "minimapzone", "dropdown", pfUI.gui.dropdowns.minimap_zone_visibility)
      CreateConfig(nil, T["Coordinates On Minimap"], C.appearance.minimap, "minimapcoords", "dropdown", pfUI.gui.dropdowns.minimap_cords_visibility)

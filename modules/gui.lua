pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(U["nameplates"], T["Draw Border Around Target Nameplate"], C.nameplates, "targethighlight", "checkbox")
      CreateConfig(U["nameplates"], T["Border Color Around Target Nameplate"], C.nameplates, "highlightcolor", "color")

pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.global, "Enable Frames To Be Placed Offscreen", pfUI_config.global, "offscreen", "checkbox")
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health Bar Animation Speed", pfUI_config.unitframes, "animation_speed")

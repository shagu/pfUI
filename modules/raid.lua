pfUI:RegisterModule("raid", function ()
  ...
  for r=1, 8 do
    for g=1, 5 do
      ...
      pfUI.api:CreateBackdrop(pfUI.uf.raid[i].hp, default_border)
      ...
      pfUI.api:CreateBackdrop(pfUI.uf.raid[i].power, default_border)
      ...
      pfUI.uf.raid[i].caption:SetFont(pfUI.font_square, pfUI_config.global.font_size, UNIT_NAME_FONT_FLAGS)

...
function pfUI:UpdateFonts()
  ...
  GameTooltipText:SetFont(pfUI_config.tooltip.font_tooltip, pfUI_config.tooltip.font_tooltip_size)
  GameTooltipTextSmall:SetFont(pfUI_config.tooltip.font_tooltip, pfUI_config.tooltip.font_tooltip_size)
  GameTooltipHeaderText:SetFont(pfUI_config.tooltip.font_tooltip, pfUI_config.tooltip.font_tooltip_size + 1)

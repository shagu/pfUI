...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("unitframes", nil,           "custom_healthtext", "0")
  pfUI:UpdateConfig("unitframes", nil,           "healthtext_color", "1,1,1,1")
  pfUI:UpdateConfig("unitframes", nil,           "custom_powertext", "0")
  pfUI:UpdateConfig("unitframes", nil,           "powertext_color",  "1,1,1,1")
  pfUI:UpdateConfig("unitframes", nil,           "powertext_color_mana",   "1,1,1,1")
  pfUI:UpdateConfig("unitframes", nil,           "powertext_color_rage",   "1,1,1,1")
  pfUI:UpdateConfig("unitframes", nil,           "powertext_color_energy", "1,1,1,1")
  pfUI:UpdateConfig("unitframes", nil,           "powertext_color_focus",  "1,1,1,1")
  ...
  for _, unit in pairs(ufs) do
    ...
    pfUI:UpdateConfig("unitframes", unit,      "custom_healthtext", "0")
    pfUI:UpdateConfig("unitframes", unit,      "healthtext_color", "1,1,1,1")
    pfUI:UpdateConfig("unitframes", unit,      "custom_powertext", "0")
    pfUI:UpdateConfig("unitframes", unit,      "powertext_color",  "1,1,1,1")
    pfUI:UpdateConfig("unitframes", unit,      "powertext_color_mana",   "1,1,1,1")
    pfUI:UpdateConfig("unitframes", unit,      "powertext_color_rage",   "1,1,1,1")
    pfUI:UpdateConfig("unitframes", unit,      "powertext_color_energy", "1,1,1,1")
    pfUI:UpdateConfig("unitframes", unit,      "powertext_color_focus",  "1,1,1,1")
  end

...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("unitframes", "player",      "hitindicator",     "1")
  ...
  pfUI:UpdateConfig("unitframes", "target",      "hitindicator",     "1")
  ...
  pfUI:UpdateConfig("unitframes", "group",       "hitindicator",     "1")
  ...
  pfUI:UpdateConfig("unitframes", "raid",        "hitindicator",     "1")
  ...
  pfUI:UpdateConfig("unitframes", "pet",         "hitindicator",     "1")
  ...
  pfUI:UpdateConfig("chat",       "bubbles",     "chat",             "1")
  pfUI:UpdateConfig("chat",       "bubbles",     "party",            "1")

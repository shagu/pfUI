...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("unitframes", "player",      "txtleft",          pf_LIST_UNIT)
  pfUI:UpdateConfig("unitframes", "player",      "txtcenter",        pf_LIST_NONE)
  pfUI:UpdateConfig("unitframes", "player",      "txtright",         pf_LIST_HEALTHDYN)
  ...
  pfUI:UpdateConfig("unitframes", "target",      "txtleft",          pf_LIST_UNIT)
  pfUI:UpdateConfig("unitframes", "target",      "txtcenter",        pf_LIST_NONE)
  pfUI:UpdateConfig("unitframes", "target",      "txtright",         pf_LIST_HEALTHDYN)
  ...
  pfUI:UpdateConfig("unitframes", "focus",       "txtleft",          pf_LIST_UNIT)
  pfUI:UpdateConfig("unitframes", "focus",       "txtcenter",        pf_LIST_NONE)
  pfUI:UpdateConfig("unitframes", "focus",       "txtright",         pf_LIST_HEALTHDYN)
  ...
  pfUI:UpdateConfig("unitframes", "group",       "txtleft",          pf_LIST_UNIT)
  pfUI:UpdateConfig("unitframes", "group",       "txtcenter",        pf_LIST_NONE)
  pfUI:UpdateConfig("unitframes", "group",       "txtright",         pf_LIST_HEALTHMISS)
  ...
  pfUI:UpdateConfig("unitframes", "grouptarget", "txtleft",          pf_LIST_UNIT)
  pfUI:UpdateConfig("unitframes", "grouptarget", "txtcenter",        pf_LIST_NONE)
  pfUI:UpdateConfig("unitframes", "grouptarget", "txtright",         pf_LIST_HEALTHPERC)
  ...
  pfUI:UpdateConfig("unitframes", "grouppet",    "txtleft",          pf_LIST_UNIT)
  pfUI:UpdateConfig("unitframes", "grouppet",    "txtcenter",        pf_LIST_NONE)
  pfUI:UpdateConfig("unitframes", "grouppet",    "txtright",         pf_LIST_HEALTHPERC)
  ...
  pfUI:UpdateConfig("unitframes", "raid",        "txtleft",          pf_LIST_NAME)
  pfUI:UpdateConfig("unitframes", "raid",        "txtcenter",        pf_LIST_NONE)
  pfUI:UpdateConfig("unitframes", "raid",        "txtright",         pf_LIST_HEALTHMISS)
  ...
  pfUI:UpdateConfig("unitframes", "ttarget",     "txtleft",          pf_LIST_NONE)
  pfUI:UpdateConfig("unitframes", "ttarget",     "txtcenter",        pf_LIST_NAME)
  pfUI:UpdateConfig("unitframes", "ttarget",     "txtright",         pf_LIST_NONE)
  ...
  pfUI:UpdateConfig("unitframes", "pet",         "txtleft",          pf_LIST_NONE)
  pfUI:UpdateConfig("unitframes", "pet",         "txtcenter",        pf_LIST_NAME)
  pfUI:UpdateConfig("unitframes", "pet",         "txtright",         pf_LIST_NONE)
  ...
  pfUI:UpdateConfig("unitframes", "fallback",    "txtleft",          pf_LIST_UNIT)
  pfUI:UpdateConfig("unitframes", "fallback",    "txtcenter",        pf_LIST_NONE)
  pfUI:UpdateConfig("unitframes", "fallback",    "txtright",         pf_LIST_HEALTHDYN)
  ...
  pfUI:UpdateConfig("panel",      "left",        "left",             pf_LIST_GUILD)
  pfUI:UpdateConfig("panel",      "left",        "center",           pf_LIST_DURABILITY)
  pfUI:UpdateConfig("panel",      "left",        "right",            pf_LIST_FRIENDS)
  pfUI:UpdateConfig("panel",      "right",       "left",             pf_LIST_FPS)
  pfUI:UpdateConfig("panel",      "right",       "center",           pf_LIST_TIME)
  pfUI:UpdateConfig("panel",      "right",       "right",            pf_LIST_GOLD)
  pfUI:UpdateConfig("panel",      "other",       "minimap",          pf_LIST_ZONE)
  ...
  pfUI:UpdateConfig("tooltip",    nil,           "position",         pf_LIST_CURSOR)
  ...
  pfUI:UpdateConfig("nameplates", nil,           "width",            "100")
  pfUI:UpdateConfig("nameplates", nil,           "heighthealth",     "6")
  pfUI:UpdateConfig("nameplates", nil,           "heightcast",       "6")

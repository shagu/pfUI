...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("appearance", "border",      "tracking",         "-1")
  ...
  pfUI:UpdateConfig("appearance", "minimap",     "tracking_size",    "20")
  pfUI:UpdateConfig("appearance", "minimap",     "tracking_pulse",   "0")

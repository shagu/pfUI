...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("panel",      "left",        "left",             "公会")
  pfUI:UpdateConfig("panel",      "left",        "center",           "耐久")
  pfUI:UpdateConfig("panel",      "left",        "right",            "好友")
  pfUI:UpdateConfig("panel",      "right",       "left",             "延迟")
  pfUI:UpdateConfig("panel",      "right",       "center",           "时间")
  pfUI:UpdateConfig("panel",      "right",       "right",            "金钱")
  pfUI:UpdateConfig("panel",      "other",       "minimap",          "地区")
  ...
  pfUI:UpdateConfig("tooltip",    nil,           "position",         "跟随鼠标")

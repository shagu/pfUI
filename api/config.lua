...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("unitframes", "player",      "pwidth",           "200")
  ...
  pfUI:UpdateConfig("unitframes", "target",      "pwidth",           "200")
  ...
  pfUI:UpdateConfig("unitframes", "focus",       "pwidth",           "120")
  ...
  pfUI:UpdateConfig("unitframes", "group",       "pwidth",           "164")
  ...
  pfUI:UpdateConfig("unitframes", "grouptarget", "pwidth",           "120")
  ...
  pfUI:UpdateConfig("unitframes", "grouppet",    "pwidth",           "100")
  ...
  pfUI:UpdateConfig("unitframes", "raid",        "pwidth",           "50")
  ...
  pfUI:UpdateConfig("unitframes", "ttarget",     "pwidth",           "100")
  ...
  pfUI:UpdateConfig("unitframes", "pet",         "pwidth",           "100")
  ...
  pfUI:UpdateConfig("unitframes", "fallback",    "pwidth",           "50")
